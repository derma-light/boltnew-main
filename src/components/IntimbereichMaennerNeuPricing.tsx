...
import { Phone, Calendar, Euro, CheckCircle, Shield, Clock, Target } from 'lucide-react';

const IntimbereichMaennerNeuPricing = () => {
  const pricingFeatures = [
    "Individuelle Preisgestaltung je nach Fläche (Brust, Bauch oder Kombination)",
  ...
  const treatmentInfo = [
    ...
    {
      icon: Clock,
      title: "Effiziente Sitzungen",
      description: "25-40 Minuten pro Behandlung, je nach Umfang"
    },
    {
      icon: Target,
  ...
  const contactOptions = [
    {
      ...
      description: "Rufen Sie uns an für eine diskrete telefonische Erstberatung",
      action: "040 55435357",
    ...
    },
    {
      ...
      description: "Erhalten Sie einen individuellen Kostenvoranschlag für Ihre Behandlung",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Preise & Beratung – Brust & Bauch
            </h2>
            <p className="text-xl text-gray-600">
              Individuelle Preisgestaltung für Ihre persönlichen Bedürfnisse.
            </p>
          </div>
          ...
          <div className="bg-blue-50 rounded-xl p-8 mb-12">
            <h3 className="text-2xl font-semibold text-gray-900 mb-6 text-center">
              Warum individuelle Preise?
            </h3>
            <p className="text-gray-700 text-center mb-8 leading-relaxed">
              Die Kosten für die Laser Haarentfernung an Brust und Bauch hängen von Haardichte, Fläche 
              und Ziel (vollständig glatt oder Reduktion) ab. Wir erstellen Ihnen ein transparentes, 
              individuelles Angebot in der Beratung.
            </p>
          ...
          <div className="text-center bg-gray-900 rounded-xl p-8">
            ...
            <p className="text-gray-300 mb-6">
              Vereinbaren Sie noch heute Ihre kostenlose und diskrete Erstberatung.
            </p>
            <a 
              href="/beratung" 
...
export default IntimbereichMaennerNeuPricing;
