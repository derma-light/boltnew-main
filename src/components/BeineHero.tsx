...
const BeineHero = () => {
  const benefitElements = [
    ...
    { icon: Shield, text: "Weniger Rasurbrand & eingewachsene Haare" },
    { icon: Zap, text: "Präzise Energieabgabe mit integrierter Kühlung" }
  ];
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-6">
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-medium mb-6">
            Laser-Haarreduktion Beine · Hamburg
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
            Dauerhaft glatte Beine – weniger Rasur, weniger Reizungen
          </h1>
          
          <h2 className="text-2xl md:text-3xl text-gray-800 font-semibold mb-6">
            Dauerhafte Haarreduktion an Unter- & Oberschenkeln mit Diodenlaser. Erste sichtbare Reduktionen häufig nach 3–5 Sitzungen.*
          </h2>
          
          <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
            Spezialisierte Bein-Haarentfernung in Hamburg mit modernster Diodenlaser-Technologie. 
            Präzise Energieabgabe mit integrierter Kühlung für dauerhaft glattere Beine.*
          </p>
