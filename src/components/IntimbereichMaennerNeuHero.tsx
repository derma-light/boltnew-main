...
import { ArrowRight, Clock, Shield, Target, Star, Award, Zap } from 'lucide-react';

const IntimbereichMaennerNeuHero = () => {
  const benefitElements = [
    { icon: Clock, text: "25–40 Min. pro Sitzung" },
    { icon: Shield, text: "Schonend dank Kontaktkühlung" },
    { icon: Target, text: "Zielgenau für Brust- & Bauchhaare" }
  ];
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-6">
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-medium mb-6">
            Laser-Haarentfernung Männer · Brust & Bauch · Hamburg
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
            Dauerhafte Laser-Haarentfernung Brust & Bauch für Männer
          </h1>
          
          <h2 className="text-2xl md:text-3xl text-gray-800 font-semibold mb-6">
            Sichtbar glatter Oberkörper – schnell, sicher und hautschonend. Bereits nach wenigen Sitzungen wirken Brust und Bauch sichtbar haarärmer.
          </h2>
          
          <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
            Professionelle Laser Haarentfernung für Männer in Hamburg – gezielt für die Bereiche Brust und Bauch. 
            Moderne Alexandrit-Lasertechnologie reduziert starke, dunkle Haare effektiv und hautschonend für ein gepflegtes, maskulines Erscheinungsbild.*
          </p>

          {/* Benefits Pills */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8" aria-label="Vorteile der Laser-Haarentfernung Brust und Bauch">
...
export default IntimbereichMaennerNeuHero;
