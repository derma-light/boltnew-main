...
const BauchHero = () => {
  const benefitElements = [
    { icon: Clock, text: "15–25 Min. pro Sitzung" },
    { icon: Target, text: "Fördert ein gleichmäßiges Hautbild" },
    { icon: Shield, text: "Angepasste Energie für unterschiedliche Haardicken" }
  ];
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-6">
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
            Spezialisierte Bauch-Haarentfernung in Hamburg mit modernster Diodenlaser-Technologie. 
            Fördert ein gleichmäßiges Hautbild durch angepasste Energie für unterschiedliche Haardicken.*
          </p>
