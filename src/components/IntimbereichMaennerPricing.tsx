...
const IntimbereichMaennerPricing = () => {
  const pricingFeatures = [
    ...
    "Paketpreise für mehrere Sitzungen verfügbar",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-blue-50 rounded-xl p-8 mb-12">
            ...
            <p className="text-gray-700 text-center mb-8 leading-relaxed">
              Die Kosten für eine Laser-Haarentfernung im Intimbereich variieren je nach gewünschtem 
              Behandlungsumfang, Haarstruktur und individuellen Bedürfnissen. In einem persönlichen 
              Beratungsgespräch erstellen wir Ihnen gerne ein maßgeschneidertes Angebot.
            </p>
...
export default IntimbereichMaennerPricing;