...
const BikinizoneProcess = () => {
  const processSteps = [
    ...
    },
    {
      ...
      description: "Mit adaptiven Parametern (808 oder 755 nm)"
    },
    {
      icon: Snowflake,
      title: "Kurze Kühlung & Pflegehinweise",
      description: "Beruhigung und Nachsorge-Informationen"
    }
  ];

  const sessionInfo = [
    "In der Regel 6-8 Sitzungen (4-8 Wochen Abstand)",
    "Individuelle Faktoren wie Haarstärke, Pigmentierung und hormonelle Einflüsse",
    "Feinere Resthaare werden später oft mit 755 nm gezielt ergänzt"
  ];
        ...
        <div className="max-w-4xl mx-auto mt-12">
          <div className="bg-green-50 rounded-xl p-6 text-center">
            <p className="text-gray-700 italic">
              *Perifollikuläre Rötung (Erythem) ist eine typische Zielreaktion und klingt meist rasch ab.
            </p>
          </div>
        </div>
...
export default BikinizoneProcess;