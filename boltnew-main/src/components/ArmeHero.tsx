...
const ArmeHero = () => {
  const benefitElements = [
    { icon: Clock, text: "25–35 Min. pro Sitzung" },
    { icon: Target, text: "Gleichmäßige Flächendeckung" },
    { icon: Shield, text: "Hautschonende Kontaktkühlung" }
  ];
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-6">
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
            Spezialisierte Arm-Haarentfernung in Hamburg mit modernster Diodenlaser-Technologie. 
            Gleichmäßige Flächendeckung, hautschonende Kontaktkühlung für dauerhaft glattere Arme.*
          </p>
