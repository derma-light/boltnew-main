...
const RueckenHero = () => {
  const benefitElements = [
    ...
    { icon: Shield, text: "Hautschonende Behandlung großer Flächen" },
    { icon: Target, text: "Speziell für männliche Rückenbehaarung" }
  ];
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-6">
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-medium mb-6">
            Laser-Haarentfernung Rücken für Männer · Hamburg
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
            Dauerhafte Haarentfernung am Rücken für Männer mit Laser
          </h1>
          
          <h2 className="text-2xl md:text-3xl text-gray-800 font-semibold mb-6">
            Die dauerhafte Haarentfernung am Rücken zeigt bereits ab der ersten Sitzung Ergebnisse. Die Laserbehandlung ist schnell, sicher und hautschonend.
          </h2>
          
          <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
            Spezialisierte Rücken-Haarentfernung für Männer in Hamburg mit modernster Laser-Technologie. 
            Die am häufigsten nachgefragte Behandlung bei Männern - schnell, sicher und hautschonend.*
          </p>
