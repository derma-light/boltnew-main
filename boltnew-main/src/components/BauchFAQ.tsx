...
const BauchFAQ = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      content: 'Erste Veränderungen oft nach 1–2 Sitzungen. Sichtbares Ausfallen (Shedding) ca. 2–3 Wochen nach dem Termin.'
    },
    {
      id: 'combination',
      title: 'Welche Zonen kann ich kombinieren?',
      content: 'Häufig: Bauch mit Bikinizone oder Brust. Details und Eignung klären wir in der Beratung.'
    }
  ];
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Alles was Sie über die Laser-Haarentfernung am Bauch wissen müssen.
            </p>
          </div>
